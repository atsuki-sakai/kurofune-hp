    ...
    <div className="overflow-hidden bg-background py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-balance text-xl/8 text-muted-foreground">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          ...
          <div className="pt-16 lg:row-span-2 lg:-mr-16 xl:mr-auto">
            <div className="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 lg:gap-4 xl:gap-8">
              <div className="aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-border/10">
                <img
                  alt=""
              ...
              <div className="-mt-8 aspect-square overflow-hidden rounded-xl shadow-xl outline outline-1 -outline-offset-1 outline-border/10 lg:-mt-40">
                <img
                  alt=""
          ...
          <div className="max-lg:mt-16 lg:col-span-1">
            ...
            <hr className="mt-6 border-t border-border/10" />
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-border pb-4">
                <dt className="text-sm/6 text-muted-foreground">Raised</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight">
                  $<span>150</span>M
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 border-b border-dotted border-border pb-4">
                <dt className="text-sm/6 text-muted-foreground">Companies</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight">
                  <span>30</span>K
                </dd>
              </div>
